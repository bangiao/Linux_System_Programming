...
${OBJECTDIR}/_ext/1683318485/13poll_cli.o: ../06SocketPro/13poll/13poll_cli.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1683318485/13poll_cli.o ../06SocketPro/13poll/13poll_cli.c

${OBJECTDIR}/_ext/1683318485/wrap.o: ../06SocketPro/13poll/wrap.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1683318485
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1683318485/wrap.o ../06SocketPro/13poll/wrap.c
